...
CREATE TABLE ad (
    ...
    company_com_companyid_pk    VARCHAR2(10) NOT NULL
);
...
CREATE TABLE department (
    ...
    station_stn_stationid_pk  VARCHAR2(10) NOT NULL
);

INSERT INTO department VALUES('3207855674', 'Streaming', '2308357777');
...
CREATE TABLE employee (
    ...
    emp_ssn                         NUMBER(9),
    department_dept_deparmentid_pk  VARCHAR2(10) NOT NULL,
    manager_man_managerid_pk        VARCHAR2(10)
);
...
INSERT INTO employee VALUES('3500363502', 'Maria', 'Suarez', '19-MAY-93', 'Streaming Associate', '000000002', '3207855674', '');
INSERT INTO employee VALUES('6072458456', 'Billy', 'Moore', '05-JUN-95', 'Streaming Associate', '000000003', '3207855674', '');
...
CREATE TABLE manager (
    employee_emp_employeeid_pk      VARCHAR2(10) NOT NULL,
...
INSERT INTO payment VALUES('5813420871', '02-NOV-20', '15.00', 'Hourly', '6072458456');
...
CREATE TABLE playlist (
    ...
    station_stn_stationid_pk    VARCHAR2(10),
    is_is_internetstationid_pk  VARCHAR2(10)
); 
...
CREATE TABLE playlist_log (
    playlist_play_playlistid_pk  VARCHAR2(10) NOT NULL,
    station_stn_stationid_pk     VARCHAR2(10),
    is_is_internetstationid_pk   VARCHAR2(10),
...
CREATE TABLE royalty_payment (
    ...
    artist_art_artistid_pk  VARCHAR2(10) NOT NULL
);
...
CREATE TABLE segment (
    ...
    playlist_play_playlistid_pk  VARCHAR2(10) NOT NULL,
    ad_ad_adid_pk                VARCHAR2(10),
    song_song_songid_pk          VARCHAR2(10)
);
...
INSERT INTO station VALUES('6066328984', 'HeartStrings', 'South', '99.3');
...
ALTER TABLE ad ADD CONSTRAINT ad_company_fk FOREIGN KEY ( company_com_companyid_pk )
    REFERENCES company ( com_companyid_pk );
        
ALTER TABLE department ADD CONSTRAINT department_station_fk FOREIGN KEY ( station_stn_stationid_pk )
    REFERENCES station ( stn_stationid_pk );      
      
ALTER TABLE employee ADD CONSTRAINT employee_department_fk FOREIGN KEY ( department_dept_deparmentid_pk )
    REFERENCES department ( dept_deparmentid_pk );
    
ALTER TABLE employee ADD CONSTRAINT employee_manager_fk FOREIGN KEY ( manager_man_managerid_pk )
    REFERENCES manager ( man_managerid_pk );

ALTER TABLE manager ADD CONSTRAINT manager_department_fk FOREIGN KEY ( department_dept_deparmentid_pk )
    REFERENCES department ( dept_deparmentid_pk );
    
ALTER TABLE manager ADD CONSTRAINT manager_employee_fk FOREIGN KEY ( employee_emp_employeeid_pk )
    REFERENCES employee ( emp_employeeid_pk );
    
CREATE UNIQUE INDEX manager__idx ON
    manager (department_dept_deparmentid_pk ASC );
    
ALTER TABLE payment ADD CONSTRAINT payment_employee_fk FOREIGN KEY ( employee_emp_employeeid_pk )
    REFERENCES employee ( emp_employeeid_pk );

ALTER TABLE playlist ADD CONSTRAINT playlist_station_fk FOREIGN KEY ( station_stn_stationid_pk )
    REFERENCES station ( stn_stationid_pk );
    
ALTER TABLE playlist_log ADD CONSTRAINT playlist_log_playlist_fk FOREIGN KEY ( playlist_play_playlistid_pk )
    REFERENCES playlist ( play_playlistid_pk );
    
ALTER TABLE playlist_log ADD CONSTRAINT playlist_log_station_fk FOREIGN KEY ( station_stn_stationid_pk )
    REFERENCES station ( stn_stationid_pk );
    
CREATE UNIQUE INDEX playlist_log__idx ON
    playlist_log (
        playlist_play_playlistid_pk
    ASC );
    
ALTER TABLE royalty_payment ADD CONSTRAINT royalty_payment_artist_fk FOREIGN KEY ( artist_art_artistid_pk )
    REFERENCES artist ( art_artistid_pk );
    
ALTER TABLE segment ADD CONSTRAINT segment_playlist_fk FOREIGN KEY ( playlist_play_playlistid_pk )
    REFERENCES playlist ( play_playlistid_pk );

ALTER TABLE segment ADD CONSTRAINT segment_ad_fk FOREIGN KEY ( ad_ad_adid_pk )
    REFERENCES ad ( ad_adid_pk );

ALTER TABLE segment ADD CONSTRAINT segment_song_fk FOREIGN KEY ( song_song_songid_pk )
    REFERENCES song ( song_songid_pk );
    
ALTER TABLE song ADD CONSTRAINT song_artist_fk FOREIGN KEY ( artist_art_artistid_pk )
    REFERENCES artist ( art_artistid_pk );